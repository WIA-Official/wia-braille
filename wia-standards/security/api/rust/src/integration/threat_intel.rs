...
impl MispClient {
    ...
    pub async fn get_attributes(&self, attr_type: &str, limit: usize) -> ThreatIntelResult<Vec<IoC>> {
        let _body = serde_json::json!({
            "returnFormat": "json",
            "type": attr_type,
            "limit": limit,
    ...
    fn map_misp_type(misp_type: &str) -> IndicatorType {
        match misp_type {
...
impl OtxClient {
    ...
    pub async fn get_subscribed_pulses(&self, limit: usize) -> ThreatIntelResult<Vec<ThreatFeed>> {
        // In production, make HTTP request
    ...
    pub async fn search_indicators(
        ...
        let type_str = match indicator_type {
...
impl VirusTotalClient {
    ...
    pub async fn get_file_report(&self, hash: &str) -> ThreatIntelResult<Option<IoC>> {
        // In production, make HTTP request
    ...
    /// Get domain report
    pub async fn get_domain_report(&self, domain: &str) -> ThreatIntelResult<Option<IoC>> {
        // In production, make HTTP request
    ...
    /// Get IP report
    pub async fn get_ip_report(&self, ip: &str) -> ThreatIntelResult<Option<IoC>> {
        // In production, make HTTP request
        // GET {base_url}/ip_addresses/{ip}
        Ok(None)
    }

    fn calculate_confidence(stats: &VtAnalysisStats) -> f64 {
