...
Built on the principle of **弘益人間 (Hongik Ingan)** - "Benefit All Humanity" - this standard aims to strengthen democracy by making civic participation accessible, secure, and meaningful for all citizens.
...
**弘益人間 (홍익인간)** - "널리 인간을 이롭게 하라"는 원칙에 기반하여, 이 표준은 모든 시민에게 시민 참여를 접근 가능하고 안전하며 의미 있게 만들어 민주주의를 강화하는 것을 목표로 합니다.
