...
"cta_desc": "Get professional accessibility consulting from WIA Books.",
"cta_button": "Go to WIA Books →",
...
**번역 후 SSH 명령어:**
sudo bash -c 'cat > /var/www/a11y.wiabooks.store/languages/a11y-ja.js << "ENDF"
[Claude 번역 결과 붙여넣기]
ENDF'
```
