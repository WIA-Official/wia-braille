...
2. 해당 프롬프트 복사
3. Claude에게 전달
4. 결과를 `/var/www/a11y.wiabooks.store/languages/a11y-[언어코드].js` 파일로 저장
...
"""
    ...
    # 파일 저장
    with open(f"/var/www/a11y.wiabooks.store/languages/a11y-{lang_code}.js", "w", encoding="utf-8") as f:
...
**출력:**
/var/www/a11y.wiabooks.store/languages/a11y-[언어코드].js 파일로 저장
```
