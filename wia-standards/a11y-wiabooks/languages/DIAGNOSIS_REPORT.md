...
sudo sed -i '/<script src="\/languages\/loader.js"><\/script>/d' /var/www/a11y.wiabooks.store/index.html
```
...
sudo sed -i 's|/languages/${langCode}.js|/languages/a11y-${langCode}.js|g' /var/www/a11y.wiabooks.store/languages/loader.js
sudo sed -i 's|translations_${langCode|translations_a11y_${langCode|g' /var/www/a11y.wiabooks.store/languages/loader.js
```
