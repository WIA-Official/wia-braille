...
// ============================================
// 211개 언어 지원 (a11y.wiabooks.store)
// ============================================
...
export class CertificationPortal {
  ...
  constructor(options?: {
    ...
    this.apiEndpoint = options?.apiEndpoint || 'https://a11y.wiabooks.store/api';
  ...
  getBadgeHtml(badge: CertificationBadge): string {
    return `<a href="https://a11y.wiabooks.store/verify/${badge.level}" target="_blank" rel="noopener">
...
export const BadgeUrls = {
  certified: 'https://a11y.wiabooks.store/badges/wia-certified.svg',
  silver: 'https://a11y.wiabooks.store/badges/wia-silver.svg',
  gold: 'https://a11y.wiabooks.store/badges/wia-gold.svg',
  platinum: 'https://a11y.wiabooks.store/badges/wia-platinum.svg',
} as const;
