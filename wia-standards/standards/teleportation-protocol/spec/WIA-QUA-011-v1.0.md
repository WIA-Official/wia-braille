...
The original Bennett et al. (1993) protocol for teleporting an arbitrary quantum state.
...
5. Barrett, M.D., et al. (2004). "Deterministic quantum teleportation of atomic qubits." *Nature*, 429(6993), 737-739.

6. Riebe, M., et al. (2004). "Deterministic quantum teleportation with atoms." *Nature*, 429(6993), 734-737.

7. Sherson, J.F., et al. (2006). "Quantum teleportation between light and matter." *Nature*, 443(7111), 557-560.

8. Krauter, H., et al. (2013). "Deterministic quantum teleportation between distant atomic objects." *Nature Physics*, 9(7), 400-404.

### 13.3 Recent Advances

9. Ren, J.G., et al. (2017). "Ground-to-satellite quantum teleportation." *Nature*, 549(7670), 70-73.

10. Valivarthi, R., et al. (2020). "Teleportation systems toward a quantum internet." *PRX Quantum*, 1(2), 020317.

11. Hermans, S.L.N., et al. (2022). "Qubit teleportation between non-neighbouring nodes in a quantum network." *Nature*, 605(7911), 663-668.
...
13. Huelga, S.F., et al. (2001). "Remote control of restricted sets of operations: Teleportation of angles." *Physical Review A*, 63(4), 042303.
