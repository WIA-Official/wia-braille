...
- Wang, J., et al. (2018). *Wearable and Implantable Biosensors*. Advanced Materials Technologies.
- Paradiso, J. A., & Starner, T. (2005). *Energy Scavenging for Mobile and Wireless Electronics*. IEEE Pervasive Computing.
- Raza, U., et al. (2017). *Low Power Wide Area Networks: An Overview*. IEEE Communications Surveys & Tutorials.
