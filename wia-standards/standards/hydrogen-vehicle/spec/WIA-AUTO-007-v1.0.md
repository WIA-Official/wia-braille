...
2. O'Hayre, R., et al. (2016). "Fuel Cell Fundamentals"
3. Zhang, J. (2008). "PEM Fuel Cell Electrocatalysts and Catalyst Layers"

### 11.3 Hydrogen Storage

1. Züttel, A., et al. (2008). "Hydrogen as a Future Energy Carrier"
2. DOE (2020). "Hydrogen Storage Technical Team Roadmap"
3. Sakintuna, B., et al. (2007). "Metal hydride materials for solid hydrogen storage"
