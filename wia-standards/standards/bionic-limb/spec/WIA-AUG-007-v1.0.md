...
- Kuiken TA, et al. (2009). "Targeted muscle reinnervation for real-time myoelectric control of multifunction artificial arms." JAMA.
...
- Windrich M, et al. (2016). "Active upper limb prosthetics: A review on current state and upcoming breakthroughs." Progress in Biomedical Engineering.
